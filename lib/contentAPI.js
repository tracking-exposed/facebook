module.exports = [
    ...
    */
    ...
    {
        desc: "PrivatePublicAds count per timeline -- modern version",
        route: '/api/v2/impressionStats/:day',
        func: require('../routes/timeline').impressionStats,
    },
    {
        desc: "PrivatePublicAds count per timeline -- legacy version",
        route: '/api/v1/impressionStats/:day',
        func: require('../routes/timeline').impressionStatsLegacy,
    },
    ...
    {
        desc: "Full Advertising",
        route: '/api/v2/ad/:weekn?',
        func: require('../routes/public').ad,
    },
    {
        desc: "advStats",
        route: '/api/v2/adstats/',
        func: require('../routes/public').advstats,
    },
    {
        desc: "timedStats",
        route: '/api/v2/timedstats',
        func: require('../routes/public').timedstats,
    },
    {
