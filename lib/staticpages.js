...
var pageMap = {
  ...
  'realitymeter': pugCompiler('realitymeter/app'),

  'realitycheck-data': pugCompiler('realitycheck/data'),
  'realitycheck-recent': pugCompiler('realitycheck/data'),
  'realitycheck-csv': pugCompiler('realitycheck/csv'),
  'realitycheck-overlook': pugCompiler('realitycheck/overlook')
};
