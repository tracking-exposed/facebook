...
function byDayStats(req) {
    ...
    var dayback = _.get(req.params, 'dayback');
    var queryMap = {
        'impressions': [
            { 
                'name': 'impressions',
               ...
               // 'filter': { impressionTime: { $gt: new Date('2016-12-09') }},
                'filter': { impressionTime: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            },
            {
                'name': 'htmls',
                ...
                'timevar': '$savingTime',
                // 'filter': { savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            },
            {
                'name': 'timelines',
                ...
                'timevar': '$startTime',
                // 'filter': { startTime: { $gt: new Date('2016-12-09') }},
                'filter': { startTime: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            }
        ],
        'users': [
            ...
            },
            {
                ...
                'timevar': '$keyTime',
               // 'filter': { keyTime: { $gt: new Date('2016-12-09') }},
                'filter': { keyTime: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            },
            {
                'name': 'notcomingback',
               ...
               // 'filter': { lastActivity: { $gt: new Date('2016-12-09') }},
                'filter': { lastActivity: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            },
            {
                'name': 'pageviews',
                ...
                'timevar': '$when',
               // 'filter': { when: { $gt: new Date('2016-12-09') }},
                'filter': { when: { $gt: new Date('2017-03-04') }},
                'aggext': {}
            }
        ],
        'metadata': [ {
                ...
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { postType: true, savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { postType: true, savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }, {
                'name': 'unexpected',
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { postType: false, savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { postType: false, savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }, {
                'name': 'feed',
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { type: "feed", savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { type: "feed", savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }, {
                'name': 'promoted',
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { type: "promoted", savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { type: "promoted", savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }, {
                'name': 'promotedowners',
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { ownerName: { "$exists": true}, savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { ownerName: { "$exists": true}, savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }, {
                'name': 'promotedpages',
                'column': nconf.get('schema').htmls,
                'timevar': '$savingTime',
               // 'filter': { promotedPage: { "$exists": true}, savingTime: { $gt: new Date('2016-12-09') }},
                'filter': { promotedPage: { "$exists": true}, savingTime: { $gt: new Date('2017-03-04') }},
                'aggext': { }
            }
        ]
    };
    ...
    debug("%s byDayStats %s (dayback %d)", req.randomUnicode, what, dayback);
