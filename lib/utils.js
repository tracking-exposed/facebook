...
var statsReshape = function(statsList) {
    return _.map(statsList, function(stOb) {
        return {
...
/* change name and abstract something from this function + 
 * jsonToColumn, they share same logic, just I don't know yet how
 * many other time I'll need to columnify, and then can be moved 
 * in dispatchPromise exit-handler */
var userLogColumnify = function(jSrc) {
...
module.exports = {
    ...
    userLogColumnify: userLogColumnify,
