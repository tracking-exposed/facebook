...
<<<<<<< HEAD
=======
// TODO check if and how much can be replaced by optionParsing and/or harmonize naming 
>>>>>>> 67566eda6449daf788d476dec864433f95eb4195
function optionParse(inputs) {

    var end = _.get(inputs, 'end') || moment().add(1, 'd').format("YYYY-MM-DD");
    var start = moment("2019-01-01").format("YYYY-MM-DD");
...
function mongoChain(filters) {
    debug("monchoChain as %j", filters);
    return Promise
