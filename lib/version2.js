...
var nodeActivity = function(req) {
    ...
    debug("%s nodeActivity with format '%s'", req.randomUnicode, format);
...
var publicPostLife = function(req) {
    ...
    debug("%s publicPostLife user %d post %d",
